...
final class GiteeRepositoryEditor extends BaseRepositoryEditor<GiteeRepository> {
  ...
  GiteeRepositoryEditor(final Project project, final GiteeRepository repository, Consumer<? super GiteeRepository> changeListener) {
  ...
  protected JComponent createCustomPanel() {
    myHostLabel = new JBLabel(GiteeBundle.message("task.repo.host.field"), SwingConstants.RIGHT);
    ...
    myRepositoryLabel = new JBLabel(GiteeBundle.message("task.repo.repository.field"), SwingConstants.RIGHT);
    myRepoAuthor = new MyTextField(GiteeBundle.message("task.repo.owner.field.empty.hint"));
    myRepoName = new MyTextField(GiteeBundle.message("task.repo.name.field.empty.hint"));
    ...
    myTokenLabel = new JBLabel(GiteeBundle.message("task.repo.token.field"), SwingConstants.RIGHT);
    myToken = new MyTextField(GiteeBundle.message("task.repo.token.field.empty.hint"));
    myTokenButton = new JButton(GiteeBundle.message("task.repo.token.create.button"));
  ...
  private void generateToken() {
    String token = GERepositoryEditorKt.INSTANCE.askToken(myProject, getHost());
    if (token != null) {
