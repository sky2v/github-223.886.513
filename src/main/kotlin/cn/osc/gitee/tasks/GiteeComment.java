...
final class GiteeComment extends SimpleComment {
  ...
  public void appendTo(StringBuilder builder) {
    ...
    if (getAuthor() != null) {
      builder.append("<b>").append(GiteeBundle.message("task.comment.author")).append("</b> <a href=\"").append(myUserHtmlUrl)
        .append("\">").append(getAuthor()).append("</a><br>");
    }
    if (getDate() != null) {
      builder.append("<b>").append(GiteeBundle.message("task.comment.date")).append("</b> ")
