...
package cn.osc.gitee.github.util
...
import cn.osc.gitee.github.authentication.GithubAuthenticationManager
...
object GithubUtil {
  ...
  @Deprecated("{@link GithubGitHelper}", ReplaceWith("GithubGitHelper.findGitRepository(project, file)",
                                                     "cn.osc.gitee.github.util.GithubGitHelper"))
  ...
  @JvmStatic
  @Deprecated("{@link cn.osc.gitee.github.api.GithubServerPath}, {@link GithubGitHelper}")
  ...
  @JvmStatic
  @Deprecated("{@link cn.osc.gitee.github.api.GithubServerPath}")
  @ApiStatus.ScheduledForRemoval
