...
class GiteeChooseAccountDialog @JvmOverloads constructor(project: Project?, parentComponent: Component?,
                                ...
                                @Nls(capitalization = Nls.Capitalization.Title) title: String = GiteeBundle.message(
                                  "account.choose.title"),
                                @Nls(capitalization = Nls.Capitalization.Title) okText: String = GiteeBundle.message(
  ...
  override fun doValidate(): ValidationInfo? {
    return if (accountsList.selectedValue == null) ValidationInfo(GiteeBundle.message("account.choose.not.selected"), accountsList)
    else null
  }

  val account: GiteeAccount get() = accountsList.selectedValue
