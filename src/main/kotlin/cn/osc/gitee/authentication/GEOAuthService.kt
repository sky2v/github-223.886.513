...
@Service
internal class GEOAuthService : OAuthServiceBase<Credentials>() {
  override val name: String get() = SERVICE_NAME

  fun authorize(): CompletableFuture<Credentials> {
    return authorize(GEOAuthRequest())
  }
  ...
  private class GEOAuthRequest : OAuthRequest<Credentials> {
    ...
    override val credentialsAcquirer: OAuthCredentialsAcquirer<Credentials> = GEOAuthCredentialsAcquirer(codeVerifier)
