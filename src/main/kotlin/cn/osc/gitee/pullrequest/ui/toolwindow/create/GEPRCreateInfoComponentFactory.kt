...
import cn.osc.gitee.pullrequest.ui.GEIOExecutorLoadingModel
import cn.osc.gitee.pullrequest.ui.GELoadingModel
import cn.osc.gitee.pullrequest.ui.GESimpleLoadingModel
import cn.osc.gitee.pullrequest.ui.details.GEPRMetadataPanelFactory
...
internal class GEPRCreateInfoComponentFactory(private val project: Project,
  ...
  private inner class CreateAction(private val directionModel: MergeDirectionModel<GEGitRepositoryMapping>,
    ...
    private fun adjustAssignees(pullRequest: GEPullRequestShort, assignees: List<GEUser>)
      : CompletableFuture<GEPullRequestShort> {
    ...
    private fun adjustLabels(pullRequest: GEPullRequestShort, labels: List<GELabel>)
      : CompletableFuture<GEPullRequestShort> {
