...
import cn.osc.gitee.api.data.GEGitActor
...
import cn.osc.gitee.pullrequest.comment.ui.GEPRReviewThreadComponent
...
class GEPRTimelineItemComponentFactory(private val project: Project,
                                       ...
                                       private val currentUser: GEUser) : TimelineItemComponentFactory<GEPRTimelineItem> {
  ...
  fun createComponent(details: GEPullRequestShort): Item {
    val contentPanel: JPanel?
    val actionsPanel: JPanel?
    if (details is GEPullRequest) {
  ...
  private fun userAvatar(user: GEGitActor?): JLabel {
    return LinkLabel<Any>("", avatarIconsProvider.getIcon(user?.avatarUrl, GEUIUtil.AVATAR_SIZE), LinkListener { _, _ ->
