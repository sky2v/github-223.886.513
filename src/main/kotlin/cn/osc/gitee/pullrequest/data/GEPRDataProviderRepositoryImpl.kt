...
import cn.osc.gitee.pullrequest.data.provider.*
...
internal class GEPRDataProviderRepositoryImpl(private val detailsService: GEPRDetailsService,
  ...
  override fun addDetailsLoadedListener(disposable: Disposable, listener: (GEPullRequest) -> Unit) {
    providerDetailsLoadedEventDispatcher.addListener(object : DetailsLoadedListener {
      override fun onDetailsLoaded(details: GEPullRequest) {
        listener(details)
      }
    }, disposable)
  }
  ...
  private interface DetailsLoadedListener : EventListener {
    fun onDetailsLoaded(details: GEPullRequest)
  }
}