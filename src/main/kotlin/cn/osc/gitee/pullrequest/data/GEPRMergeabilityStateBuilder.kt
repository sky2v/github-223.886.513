...
import cn.osc.gitee.api.data.pullrequest.GEPullRequestMergeStateStatus
import cn.osc.gitee.api.data.pullrequest.GEPullRequestMergeabilityData
import cn.osc.gitee.api.data.pullrequest.GEPullRequestMergeableState
import cn.osc.gitee.pullrequest.data.GEPRMergeabilityState.ChecksState
  ...
  fun build(): GEPRMergeabilityState {
    ...
    for (suite in checkSuites) {
      when (suite.status) {
        ...
        GECommitCheckSuiteStatusState.PENDING,
        GECommitCheckSuiteStatusState.WAITING,
