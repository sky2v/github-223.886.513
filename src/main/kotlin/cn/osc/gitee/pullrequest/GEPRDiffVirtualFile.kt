...
internal class GEPRDiffVirtualFile(fileManagerId: String,
  ...
  override fun createProcessor(project: Project): DiffRequestProcessor {
    ...
    val diffProcessor = GEPRDiffRequestChainProcessor(project, diffRequestModel)
  ...
  override fun getPath(): String =
    (fileSystem as GEPRVirtualFileSystem).getPath(fileManagerId, project, repository, pullRequest, null, true)
