...
import cn.osc.gitee.exceptions.GiteeOperationCanceledException;
...
import static cn.osc.gitee.util.GiteeUtil.getErrorTextFromException;

public final class GiteeNotifications {
  ...
  public static AnAction getConfigureAction(@NotNull Project project) {
    return NotificationAction.createSimple(GitBundle.messagePointer("action.NotificationAction.GiteeNotifications.text.configure"),
                                           () -> ShowSettingsUtil.getInstance()
                                             .showSettingsDialog(project, GiteeUtil.SERVICE_DISPLAY_NAME));
  }
}
