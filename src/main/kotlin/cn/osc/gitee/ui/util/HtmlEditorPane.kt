...
internal class HtmlEditorPane() : BaseHtmlEditorPane() {
  ...
  init {
    editorKit = HTMLEditorKitBuilder().withViewFactoryExtensions(ExtendableHTMLViewFactory.Extensions.WORD_WRAP, GEExtensions()).build()
  }
  ...
  private class GEExtensions : ExtendableHTMLViewFactory.Extension {
