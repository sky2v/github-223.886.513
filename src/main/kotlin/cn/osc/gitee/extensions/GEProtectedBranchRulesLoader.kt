...
import cn.osc.gitee.util.GiteeProjectSettings
  ...
  private fun loadProtectionRules(indicator: ProgressIndicator,
    ...
    for ((repository, remotes) in fetches) {
      ...
      for (remote in remotes) {
        ...
        SimpleGHGQLPagesLoader(requestExecutor, { GEGQLRequests.Repo.getProtectionRules(repositoryMapping.repository) })
